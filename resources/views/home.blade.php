            ...
            <div class="row">
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card-box">
                        ...
                        <h4 class="header-title mt-0 mb-4">Clients Today</h4>
                        ...
                        <div class="widget-chart-1">
                            ...
                            <div class="widget-detail-1 text-right">
                                <h2 class="font-weight-normal pt-2 mb-1"> 10 </h2>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card-box">
                        ...
                        <h4 class="header-title mt-0 mb-3">Clients This Week</h4>
                        ...
                        <div class="widget-box-2">
                            <div class="widget-detail-2 text-right">
                                ...
                                <p class="text-muted mb-3">date --to date</p>
                            </div>
